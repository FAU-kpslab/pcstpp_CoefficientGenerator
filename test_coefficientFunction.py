...
class Test_B_DifferentialEquation(unittest.TestCase):
    ...
    def test_calc(self):
        self.assertEqual(calc((('0.id','0.id'),tuple()),collection,translation,2,signum),QuasiPolynomial.zero())
        self.assertEqual(calc((('-2.id','2.id'),tuple()),collection,translation,2,signum),
